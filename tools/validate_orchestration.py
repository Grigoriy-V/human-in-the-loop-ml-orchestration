...
def main(argv=None):
 ...
 if adapter:
  required=['AGENTS.md','PROJECT_LOG.md','PROJECT_ROADMAP.md','orchestration.lock.json','tools/agent_ledger.py','reports/agent_execution_ledger.schema.json','reports/agent_execution_ledger.jsonl']
 ...
 for x in ['reports/agent_execution_ledger.schema.json','core/task_spec.schema.json','core/project_manifest.schema.json']:
  try:
